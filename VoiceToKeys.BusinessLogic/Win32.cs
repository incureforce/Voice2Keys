...
namespace VoiceToKeys {
	...
	internal static class Win32 {
		...
		[DllImport("user32.dll")]
		internal static extern uint MapVirtualKey(uint code, MapVirtualKeyType type);
	...
	internal enum InputType : uint {
		/// <summary>
		/// The event is a mouse event. Use themistructure of the union.	
		///</summary>
		MOUSE = 0,
		/// <summary>
		/// The event is a keyboard event. Use thekistructure of the union.	
		///</summary>
		KEYBOARD = 1,
		/// <summary>
		/// The event is a hardware event. Use thehistructure of the union.	
		///</summary>
		HARDWARE = 2,
	}
	...
	internal struct KeyboardInput {
		...
		internal KeyboardInputEventFlags EventFlags;
	...
	internal struct MouseInput {
		...
		internal int Y;
		internal uint Data;
		internal MouseInputEventFlags EventFlags;
		internal uint TimeStamp;
	...
	internal struct HardwareInput {
		...
		internal ushort LParam;
		internal ushort HParam;
	}

	[Flags]
	internal enum KeyboardInputEventFlags : uint {
		/// <summary>
		/// orig: KEYEVENTF_EXTENDEDKEY
		/// If specified, the scan code was preceded by a prefix byte that has the value 0xE0 (224).
		/// </summary>
		EXTENDEDKEY = 0x0001,
		/// <summary>
		/// orig: KEYEVENTF_KEYUP
		/// If specified, the key is being released. If not specified, the key is being pressed.
		/// </summary>
		KEYUP = 0x0002,
		/// <summary>
		/// orig: KEYEVENTF_UNICODE
	...
	[Flags]
	internal enum MouseInputEventFlags : uint {
		/// <summary>
		/// Thedxanddymembers contain normalized absolute coordinates. If the flag is not set,dxanddycontain relative data (the change in position since the last reported position). This flag can be set, or not set, regardless of what kind of mouse or other pointing device, if any, is connected to the system. For further information about relative mouse motion, see the following Remarks section.///
		///</summary>
		MOVE_ABSOLUTE = 0x8000,
		/// <summary>
		/// The wheel was moved horizontally, if the mouse has a wheel. The amount of movement is specified inmouseData.Windows XP/2000:This value is not supported.
		///</summary>
		HWHEEL = 0x01000,
		/// <summary>
		/// Movement occurred.
		...
		/// <summary>
		/// TheWM_MOUSEMOVEmessages will not be coalesced. The default behavior is to coalesceWM_MOUSEMOVEmessages.Windows XP/2000:This value is not supported.
		///</summary>
		MOVE_RELATIVE_NOCOALESCE = 0x2000,
		/// <summary>
		...
		MBUTTON_UP = 0x0040,
		/// <summary>
		/// Maps coordinates to the entire desktop. Must be used withMOUSEEVENTF_ABSOLUTE.
		///</summary>
		VIRTUALDESK = 0x4000,
		/// <summary>
		/// The wheel was moved, if the mouse has a wheel. The amount of movement is specified inmouseData.
		///</summary>
		VWHEEL = 0x0800,
		/// <summary>
